...
[
  {
    "id": "1761255659418",
    "text": "iStock: I understand how to use this interface to accomplish the task of image search & retrieval.",
    "answers": [
      "4",
      "4",
      "5",
  ...
  {
    "id": "1761253377401",
    "text": "Prototype A: I understand how to use this interface to accomplish the task of image search and retrieval.",
    "answers": [
      "2",
      "4",
      "5",
  ...
  {
    "id": "1761256119986",
    "text": "Prototype B: I understand how to use this interface to accomplish the task of image search and retrieval.",
    "answers": [
      "2",
      "4",
      "5",
  ...
  {
    "id": "1761256385078",
    "text": "Prototype C: I understand how to use this interface to accomplish the task of image search and retrieval.",
    "answers": [
      "2",
      "4",
      "5",
...
def perform_statistical_tests(all_answers, interfaces):
    ...
    # 2. Kruskal-Wallis Test (non-parametric alternative to one-way ANOVA)
    print("\n2. Kruskal-Wallis H-Test:")
    print("-" * 40)
    h_stat, p_value = stats.kruskal(*all_answers)
    ...
    if p_value < 0.05:
        ...
        for i in range(len(interfaces)):
            for j in range(i+1, len(interfaces)):
                u_stat, p_val = stats.mannwhitneyu(all_answers[i], all_answers[j], 
                                                   alternative='two-sided')
                print(f"    {interfaces[i]} vs {interfaces[j]}: p = {p_val:.4f}", end="")
                if p_val < 0.05:
                    print(" *")
                else:
                    print()
